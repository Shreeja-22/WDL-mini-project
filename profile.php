...
.navbar{
    ...
    flex-direction: row;
    flex-wrap: wrap;
    background: linear-gradient(rgba(0,0,0,0.6),rgba(0,0,0,0.6)),url(images/bookstore1.jpg);
    width: 100%;
    height: 70px;
    z-index: 1;
}
...
<body>
    ...
    <p id="demo" style="margin-top: 70px; margin-bottom: 0px; margin-left: 700px; font-size: 15px; color: black "></p>

    <div class="display">
        <h1 style="margin-bottom: 10px; margin-top: 0px;">My Profile</h1><hr>
    </div>
    <div class="profile">
        <h2>Name:</h2>
        <p><?=$_SESSION['user'];?></p>
